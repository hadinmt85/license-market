    ...
    return (
        <>
            <div className="h-14 w-full bg-gray-900 mt-55 flex flex-row gap-11 items-center justify-center max-sm:h-auto max-sm:flex-col max-sm:gap-5 max-sm:py-5 max-sm:mt-20">
                <Link href={"#"} className="text-white cursor-pointer hover:text-gray-400 text-lg">صفحه نخست</Link>
                <Link href={"#"} className="text-white cursor-pointer hover:text-gray-400 text-lg">بلاگ</Link>
                <Link href={"#"} className="text-white cursor-pointer hover:text-gray-400 text-lg">قوانین</Link>
                <Link href={"#"} className="text-white cursor-pointer hover:text-gray-400 text-lg">درباره ما</Link>
                <Link href={"#"} className="text-white cursor-pointer hover:text-gray-400 text-lg">ارتباط با ما</Link>
            </div>
            <div className="h-40 w-full bg-black flex flex-row justify-between items-center px-40 py-22 max-sm:h-auto max-sm:flex-col max-sm:px-4 max-sm:py-8 max-sm:gap-8">
                <div className="flex flex-col items-start gap-6 max-sm:items-center">
                    <div className="flex flex-row items-center gap-10 max-sm:gap-5">
                        ...
                        <div className="flex flex-row gap-1 items-cente cursor-pointer">
                            ...
                            <span className="text-white font-semibold text-lg">۰۲۱۹۱۰۹۴۴۰۰</span>
                        </div>
                    </div>
                ...
                <div className="flex flex-col items-center">
                    <p className="text-white font-semibold mb-3 text-xl">مجوز ها و نماد های فعالیت</p>
